...
"color: rgb(148, 143, 163)")
        ...
        self.submit_credentials_5 = QtWidgets.QPushButton(self.frame_9)
        self.submit_credentials_5.setStyleSheet("QPushButton {background-color: rgb(86,57,172);\n"
"color: rgb(255, 255, 255);\n"
"padding: 6px;\n"
"border-radius:8px;\n"
"max-width:110px;\n"
...
"}\n"
"")
        self.submit_credentials_5.setIcon(icon)
        self.submit_credentials_5.setObjectName("submit_credentials_5")
        self.formLayout_5.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.submit_credentials_5)
        self.comboBox = QtWidgets.QComboBox(self.frame_9)
        self.comboBox.setStyleSheet("background-color: rgb(61, 57, 70);\n"
"border: none;\n"
"padding: 6px;\n"
"border-radius: 4px;\n"
"color: rgb(255,255,255);\n"
"font: 63 10pt \"Torus Pro SemiBold\";")
    ...
    def retranslateUi(self, SettingsWindow):
        ...
        self.submit_credentials_5.setText(_translate("SettingsWindow", "Save"))
        self.comboBox.setItemText(0, _translate("SettingsWindow", "No Limit"))
        self.comboBox.setItemText(1, _translate("SettingsWindow", "Every 5 Seconds"))
        self.comboBox.setItemText(2, _translate("SettingsWindow", "Every 10 Seconds"))
        self.comboBox.setItemText(3, _translate("SettingsWindow", "Every 15 Seconds"))
        self.comboBox.setItemText(4, _translate("SettingsWindow", "Every 30 Seconds"))
        self.comboBox.setItemText(5, _translate("SettingsWindow", "Every Minute"))
