...
seconds as it may cause spamming of the refresh button.
    ...
    def setupUi(self):
        ...
        self.submit_credentials = SettingsButton('Submit')
        self.formLayout_3.setWidget(
            6, QtWidgets.QFormLayout.FieldRole, self.submit_credentials)
        self.get_credentials_3 = SettingsButton('Get Credentials')
        self.formLayout_3.setWidget(
